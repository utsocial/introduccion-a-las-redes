...
(VideoComp = function(obj) {
 ...
 //            videoFrame = document.createElement("iframe");
 //            videoFrame.title = iframeTitle;
 //            videoFrame.src = "//fast.wistia.net/embed/iframe/" + obj.videoId + "?seo=false&allowtransparency=true&frameborder=0&scrolling=no&class=wistia_embed&name=wistia_embed&allowfullscreen&mozallowfullscreen";
 //        }
 //        videoFrame.width = 640;
 //        videoFrame.height = 390;
 //        videoFrame.id = "vdo";
 //        videoFrame.style.cssText = "position:absolute;top:"+ obj.y + ";left:"+ obj.x + ";visibility:hidden;border:0;-webkit-backface-visibility: hidden !important;"
 //        $("#" + obj.div).append(videoFrame);
 ...
 //        resize();
	...
	$('<script src="//fast.wistia.com/assets/external/E-v1.js" async></' + 'script>').appendTo(document.body);
        ...
        //$('<iframe src="//fast.wistia.net/embed/iframe/' + obj.videoId + '?seo=false&allowtransparency="true"&frameborder=0&scrolling=no&class=wistia_embed&name=wistia_embed&allowfullscreen&mozallowfullscreen width="' + obj.width + '" height="' + obj.height + '" style="left:' + obj.x + '; position:absolute;top:' + obj.y + ';"></iframe>').appendTo(document.body);
        $('<iframe id = "vdo" src="//fast.wistia.net/embed/iframe/' + obj.videoId + '?seo=false" title="'+iframeTitle+'" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen oallowfullscreen msallowfullscreen width="' + obj.width + '" height="' + obj.height + '" style="left:' + obj.x + '; position:absolute;top:' + obj.y + ';"></iframe>').appendTo(document.body);
    } else {
